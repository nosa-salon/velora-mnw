...
const systemUsers = {
    ...
    dohaa: { name: "دعاء", role: "مساعد إدارة", pass: "dohaa123", access: ["pos-order", "inventory", "orders", "invoice-query"] },
    mona: { name: "منى", role: "مساعد إدارة", pass: "mona123", access: ["pos-order", "inventory", "orders", "invoice-query"] },
...
function buildSidebarMenu() {
    ...
    if(currentUser.key === 'admin') menuHTML += `<li data-target="electronic-invoice"><i class="fa-solid fa-file-invoice"></i> طباعة الفاتورة الإلكترونية</li>`;
